...
export const DroneAssignmentModal: React.FC<DroneAssignmentModalProps> = ({
  ...
  const handleAssign = () => {
    ...
    mockStore.assignDroneToOrder(order.id, droneIdToAssign);
      ...
      <div className="space-y-4 text-xs text-slate-700 dark:text-slate-200">
        ...
        <div className="flex items-center justify-end gap-3 pt-3 border-t border-slate-200 dark:border-slate-800">
          ...
          <button
            ...
            disabled={!recommendedDrone && !selectedDroneId}
          ...
          >
            <CheckCircle2 className="h-4 w-4" /> Confirm Drone Assignment & Dispatch
          </button>
        </div>
      </div>
    </Modal>
