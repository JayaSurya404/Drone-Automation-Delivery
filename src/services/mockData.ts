...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  // Fresh Groceries & Essentials
  {
    ...
    description: 'Hand-picked ripe Mexican Hass avocados (4x) and fresh sweet golden berries (250g) harvested this morning.',
    price: 11.50,
    originalPrice: 16.00,
    discountPercent: 28,
    rating: 4.6,
    ...
    features: ['100% Certified organic', 'Zero bruising in aerial transit', 'Optimal ripeness guarantee'],
    specifications: {
      'Quantity': '4 Avocados + 250g Berries',
      'Origin': 'California Organic Co-op',
      'Weight': '800 grams',
    },
